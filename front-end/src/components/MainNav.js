  ...
  return (
    <div className="fixed bottom-0 z-50 flex mx-auto justify-between items-center w-full px-10 py-1 text-center font-semibold rounded-t-md bg-white">
      <div>
        <Link
          to="/discussion-home"
          className={currpath === "/discussion-home" ? activeEl : nonActiveEl}
        >
          <svg
      ...
      <div className="">
        <Link
          to="/outfit-collection"
          className={currpath === "/outfit-collection" ? activeEl : nonActiveEl}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      <div className="">
        ...
        <Link
          to="/home"
          className={currpath === "/home" ? activeEl : nonActiveEl}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
