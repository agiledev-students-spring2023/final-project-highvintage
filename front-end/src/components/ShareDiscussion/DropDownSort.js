  ...
  return (
    ...
    <div className="relative">
        <button
          ...
          className="fixed right-0 mr-1 py-2 px-4 bg-gray-800 text-white rounded-md font-medium hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
        >
          {props.menuName}{" "}
          <svg
