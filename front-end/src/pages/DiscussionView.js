...
export default function DiscussionView(props) {
  ...
  return (
    ...
    <br></br>
    <DiscussionFullView title = {user[0].discussion[0].title} photo = {user[0].photo} content = {user[0].discussion[0].content} username = {user[0].username} date = {user[0].discussion[0].date}></DiscussionFullView>
    </>
